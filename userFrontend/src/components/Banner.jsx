    ...
    <div className='h-[60vh] w-full px-10 py-[10vh] relative'>
        ...
        <div className='w-full h-full  bg-blue-600 rounded-md flex items-center  justify-end'>
            <div className='w-[60%] h-full flex flex-col  justify-evenly  items-start '>
                ...
                <div className="w-[80%] text-2xl font-medium text-white leading-none tracking-tight">
                  Save up to 10%. Limited-time offer. Free delivery with PLANS Membership.
               </div>
               <button className="rounded-full bg-yellow-500 text-white font-medium py-2 px-8 text-sm">Join Now</button>
           </div>
          </div> 
    </div>
  )
