...
const Footer = () => {
  return (
    <footer className="bg-gray-800 text-gray-200 py-10 px-6 mt-10">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        {/* Logo & About */}
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">Medinest</h1>
        ...
        <div>
          ...
          <p className="text-sm text-gray-400">Email: support@medinest.in</p>
          <p className="text-sm text-gray-400">Phone: +91 98765 43210</p>
          <div className="flex space-x-4 mt-4">
            <a href="#" className="text-xl hover:text-white"><FaFacebookF /></a>
            <a href="#" className="text-xl hover:text-white"><FaTwitter /></a>
            <a href="#" className="text-xl hover:text-white"><FaInstagram /></a>
            <a href="#" className="text-xl hover:text-white"><FaLinkedin /></a>
          </div>
        </div>
      </div>
